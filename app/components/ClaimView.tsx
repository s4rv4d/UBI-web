...
export function ClaimView() {
  ...
  return (
    <>
      ...
      <CardContent className="space-y-4 ock-font-family">
        ...
        <div className="flex flex-row justify-center items-center gap-2">
          <span className={cn("font-semibold text-8xl", color.foregroundMuted)}>
            {claimAllocation
              ? humanCheckVerified
      ...
      <CardFooter className="flex flex-col ock-font-family">
        <div className="flex items-start p-4 rounded-lg bg-yellow-100 border border-yellow-400">
          ...
          <p className="text-yellow-700 text-xs">
            Criteria to claim is to have a score greater than or equal to 60 and
            human verified.
          </p>
        </div>
